import os
from PySide6.QtWidgets import QFrame, QVBoxLayout, QHBoxLayout, QLabel, QApplication, QFileDialog
...
class WebPreviewPage(QFrame):
    ...
    def startWebServer(self):
        """启动Web服务器"""
        try:
            from app.gui.web_server import start_server
    ...
    def loadModelToPreview(self):
        ...
        try:
            from app.gui.web_server import mount_model_dir
            import requests
            import json
