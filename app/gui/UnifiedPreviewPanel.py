...
class UnifiedPreviewPanel(QFrame):
    """Shared preview surface for image lists and embedded Live2D models."""

    def __init__(self, parent=None, object_name: str = "unifiedPreviewPanel"):
